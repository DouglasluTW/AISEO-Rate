...
const signalOrder = [
  ...
  ["Topic risk", (payload) => payload.signals.topic_risk],
  ["FAQ section", (payload) => (payload.signals.has_faq_section ? "Yes" : "No")],
  ["Conclusion first", (payload) => (payload.signals.conclusion_first ? "Yes" : "No")],
  ["Recommendation", (payload) => (payload.signals.recommendation_signal ? "Yes" : "No")],
  ["Trade-off signal", (payload) => (payload.signals.tradeoff_signal ? "Yes" : "No")],
  ...
  ["Specific details", (payload) => String(payload.signals.specificity_markers)],
